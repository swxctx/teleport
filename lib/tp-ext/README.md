...
[Teleport v3](https://github.com/swxctx/teleport/tree/v3) custom extensions collection.


## Install

```sh
go get -u -f -d github.com/swxctx/teleport/lib/tp-ext/...
```
...
[ignoreCase](https://github.com/swxctx/teleport/lib/tp-ext/blob/master/plugin-ignoreCase)|`import ignoreCase "github.com/swxctx/teleport/lib/tp-ext/plugin-ignoreCase"`|Dynamically ignoring the case of path
...
[pbproto](https://github.com/swxctx/teleport/lib/tp-ext/blob/master/proto-pbproto)|`import pbproto "github.com/swxctx/teleport/lib/tp-ext/proto-pbproto"`|A PTOTOBUF socket communication protocol
[tpV2Proto](https://github.com/swxctx/teleport/lib/tp-ext/blob/master/proto-tpV2Proto)|`import tpV2Proto "github.com/swxctx/teleport/lib/tp-ext/proto-tpV2Proto"`|Compatible teleport v2 protocol
